...
{
    public static void WriteWeapon(this NetworkWriter writer, Weapon_SO armor)
    {
        writer.WriteString(armor.name);
    }

    public static Weapon_SO ReadWeapon(this NetworkReader reader)
    {
        return (Weapon_SO)Resources.Load(reader.ReadString());
    }
}


#region weaponScriptableObject
[CreateAssetMenu(fileName = "NewWeapon", menuName = "Weapon/New Weapon", order = 1)]
public class Weapon_SO : ScriptableObject
{
    [Tooltip("Integer. Each weapon MUST have an unique ID. Do not skip ID values.")]public int weaponID;
    ...
    [Tooltip("Type of shooting. Hitscan = Instant hit on shooting." +
        ...
        "Melee: Close range weapons such as swords or knives.")] public ShootStyle shootStyle;
    ...
    [Tooltip("Time elapsed until the next bullet spawns. Keep this at 0" +
        ...
        "Change its value in order to make burst weapons.")] public float timeBetweenShots; 
    ...
    [Tooltip("FOV amount on shooting"),Range(0,180)] public float FOVValue;

    [Tooltip("FOV amount on shooting"), Range(0, 180)] public float AimingFOVValue;
    ...
    [Tooltip("For projectile, not explotion effect ")] public bool onHitEffect;
...
//                         case 1:    
//                             EditorGUI.indentLevel++;
//                             EditorGUILayout.PrefixLabel("Attach your Projectile here");
...
//                                 EditorGUILayout.LabelField("Check new options under 'Visuals' tab. ", EditorStyles.miniLabel);
//                                 EditorGUI.indentLevel--;
//                             }
//                             WeaponShootingSharedVariables(myScript);
...
//                             {
//                                 EditorGUI.indentLevel++;
//                                 EditorGUILayout.PropertyField(serializedObject.FindProperty("FOVValue"));   
//                                 EditorGUI.indentLevel--;
//                             }
...
//                 {
//                     EditorGUI.indentLevel++;
//                     EditorGUILayout.LabelField("Check new options under spread options. ", EditorStyles.miniLabel);
//                     EditorGUI.indentLevel--;
//                 }
//                 EditorGUI.indentLevel++;
...
//             EditorGUILayout.PropertyField(serializedObject.FindProperty("FOVValue"));
//             EditorGUI.indentLevel++;
//             EditorGUILayout.LabelField("Your normal aiming FOV value is " + myScript.aimingFOV);
//             EditorGUI.indentLevel--;
//             EditorGUILayout.PropertyField(serializedObject.FindProperty("AimingFOVValue"));
//             EditorGUI.indentLevel--;
//         }
//         EditorGUILayout.Space(5f);
