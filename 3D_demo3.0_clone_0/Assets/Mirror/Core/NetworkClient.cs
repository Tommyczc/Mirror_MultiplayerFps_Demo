    ...
    public static partial class NetworkClient
    {
        ...
        internal static void OnChangeOwner(ChangeOwnerMessage message)
        {
            ...
            if (identity != null)
                ...
                Debug.LogWarning($"OnChangeOwner: Could not find object with netId {message.netId}");
        }
        ...
        static void Broadcast()
        {
            ...
            foreach (NetworkIdentity identity in connection.owned)
            {
                ...
                else Debug.LogWarning($"Network identity {identity.assetId} found 'null' entry in observing list for connectionId={connection.connectionId}. Please call NetworkServer.Destroy to destroy networked objects. Don't use GameObject.Destroy.");
            }
        }
